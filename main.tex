...
He submitted this in his thesis as \textit{About the Best Approximation of Continuous Functions by Polynomials of Given Degree} to receive his second doctorate from Kharkov University.
...
\begin{equation*}
    y\approx p(r)+p'(r)(x-r) \ \text{at}\ x=r
\end{equation*}
\begin{figure}
\centering
...
\end{equation}
where $B_{i,n}(t)$ is the \emph{Bernstein Polynomial} defined on $\left[0,1 \right]$ at equation(\ref{eqn:bp}).
